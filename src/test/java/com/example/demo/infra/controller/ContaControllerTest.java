...
import com.example.demo.infra.gateway.bd.ContaRepository;
...
public class ContaControllerTest {
    ...
    void criarConta_ComSucesso_DeveRetornarStatus201() throws Exception {
        // Arrange
        String requestBody = objectMapper.writeValueAsString(new Conta(1L, 2L, 3L, BigDecimal.ZERO, "Lucas", "123456789", "Corrente"));
    ...
    void criarConta_JaExistente_DeveRetornarStatusBadRequest() throws Exception {
        // Arrange
        Conta conta = new Conta(1L, 2L, 3L, BigDecimal.ZERO, "Lucas", "123456789", "Corrente");
    ...
    void criarConta_ComSucesso_DeveSalvarAConta() throws Exception {
        ...
        Assertions.assertEquals("Lucas", contaCriada.getTitular());
    }
}
